  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 md:gap-10">
        <div className=" max-w-[106px] flex items-center justify-center min-h-[136px] min-w-[106px p-5 md:max-w-[120px] md:min-h-[140px] md:min-w-[120px] bg-bgColor my-[10px]">
