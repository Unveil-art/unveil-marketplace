  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 md:gap-10">
        <Link href={wishlist ? `/gallery/artwork/${item.id}` : item.listed ? `/gallery/artwork/${item.id}` : `/artworks/${item.id}`} className="max-h-[136px] max-w-[106px] min-h-[136px] min-w-[106px] md:max-h-[140px] md:max-w-[120px] md:min-h-[140px] md:min-w-[120px] bg-bgColor my-[10px]">
