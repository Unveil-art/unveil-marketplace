...
import { getCurrentExchangeRateETHUSD, getOwnedNfts, getUserMe } from "lib/backend";
      ...
      <div className="ml-[40px] pt-[80px] md:pt-[160px] md:ml-[35svw] mb-10 pr-[15px] md:pr-10">
        <div>
          ...
          {ownedEditions.map((edition, i) => (
              <NFTsListItem key={edition.id} edition={edition} currentExchangeRate={exchangeRate} />
            ))}
        </div>
      </div>
    </Animate>
