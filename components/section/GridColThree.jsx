...
const GridColThree = () => {
  return (
    <section className="grid md:grid-cols-3 p-10 md:mb-[60px] group">
      ...
      <div className="relative pl-[56px] border-t pt-3 mt-3 md:pt-0 md:border-t-0  border-unveilGrey pr-[10px] mr-[30px]">
        <div className="absolute left-0 scale-75 top-3 md:top-0 md:scale-100">
          <Tag />
        </div>
        <h3 className="s1">Enrich your art collection</h3>
