...
const Link = ({ data }) => {
  ...
  return (
    ...
    >
      <div class="gsap-line border-t-unveilBlack md:border-t-[3px]"></div>
      <div className="flex items-center justify-between w-full gap-5 gsap-transform">
        <div>
      ...
      <div class="gsap-line md:border-b border-b-unveilDrakGray"></div>
    </section>
  );
};
