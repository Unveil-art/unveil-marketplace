        ...
        <p
          className={`${
            data.link && data.button_text
              ? "md:max-w-[320px]"
              : "md:max-w-[350px]"
          }  sticky top-[32px] h-fit leading-[110%] px-[15px] ml-[100px] md:ml-10 2xl:ml-[60px] s2 drop-cap`}
        >
          {data.Text}
        </p>
        {data.link && data.button_text && (
          <div className="block bg-unveilWhite border border-bgColorHover rounded-[10px] overflow-hidden absolute md:sticky top-[180px] right-[15px] md:right-10 h-fit">
            ...
            <a target="_blank" rel="noreferrer" href={data.link}>
              <div className="py-2  uppercase cursor-pointer text-center bg-unveilBlack text-unveilWhite text-[8px] md:text-[12px] l1 tracking-[0.15rem]">
                {data.button_text}
              </div>
            </a>
          </div>
