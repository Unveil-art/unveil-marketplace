...
import { getClientSecretForShipping, getCurrentExchangeRateETHUSD, getEditionById, makePrintRequest } from "lib/backend";
...
const PrintNft = ({ edition }) => {
  ...
  const onSubmitForm = async (data) => {
    ...
    if (provider) {
      ...
      showTopStickyNotification("error", "Invalid Provider! please sign in again")
    }
  };
  ...
  return (
    <>
      {secretSdkClient && !!formData && <div onClick={(e) => {
        setSecretSdkClient("");
        e.stopPropagation();
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
              <div className="grid grid-cols-2 mb-[15px] md:gap-x-[15px] gap-x-2 ">
                <div className="relative">
                  ...
                  />
                  <p
                    className={`text-red-500 opacity-0 b5 absolute -bottom-5 left-0 ${errors.firstName?.message ? "opacity-100" : ""
                      }`}
                  >
                ...
                <div className="relative">
                  ...
                  />
                  <p
                    className={`text-red-500 opacity-0 b5 absolute -bottom-5 left-0 ${errors.lastName?.message ? "opacity-100" : ""
                      }`}
                  >
              ...
              <div className="relative mb-[15px]">
                ...
                />
                <p
                  className={`text-red-500 opacity-0 b5 absolute -bottom-5 left-0 ${errors.address?.message ? "opacity-100" : ""
                    }`}
                >
              ...
              <div className="grid grid-cols-2 mb-[15px] md:gap-x-[15px] gap-x-2 ">
                <div className="relative">
                  ...
                  />
                  <p
                    className={`text-red-500 opacity-0 b5 absolute -bottom-5 left-0 ${errors.postalCode?.message ? "opacity-100" : ""
                      }`}
                  >
                ...
                <div className="relative">
                  ...
                  />
                  <p
                    className={`text-red-500 opacity-0 b5 absolute -bottom-5 left-0 ${errors.city?.message ? "opacity-100" : ""
                      }`}
                  >
                    {errors.city?.message}
                  </p>
              ...
              <div className="relative mb-[15px]">
                ...
                <p
                  className={`text-red-500 opacity-0 b5 absolute -bottom-5 left-0 ${errors.country?.message ? "opacity-100" : ""
                    }`}
                >
              ...
              <div className="relative mb-14">
                ...
                />
                <p
                  className={`text-red-500 opacity-0 b5 absolute -bottom-5 left-0 ${errors.phone?.message ? "opacity-100" : ""
                    }`}
                >
