...
export async function getUsers(value, role) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/user?user_role=${role}`,
    {
      headers: {
...
export async function uploadAudio(value, fileToUpload) {
  ...
  const res = await axios.post(
    "https://marketplace-backend-dev.unveil.art/api/v1/upload/audio",
    formdata,
    {
      headers: {
...
export async function getCollections(skip, limit) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/collection?skip=${skip}&limit=${limit}`,
    {
      headers: {
        "content-type": "application/json",
      },
...
export async function getUserMe(value) {
  const res = await fetch(
    "https://marketplace-backend-dev.unveil.art/api/v1/user/me",
    {
      headers: {
        "content-type": "application/json",
        authorization: `Bearer ${value}`,
...
export async function getCollectionsMe(value, extended) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/collection/collections/me`,
    {
      headers: {
        "content-type": "application/json",
        authorization: `Bearer ${value}`,
...
export async function getCollectionsSearch(search) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/collection?search=${search}`,
    {
      headers: {
        "content-type": "application/json",
      },
...
export async function getArtworks(skip, limit) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork?skip=${skip}&limit=${limit}`,
    {
      headers: {
        "content-type": "application/json",
      },
...
export async function getArtworksSearch(search) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork?search=${search}`,
    {
      headers: {
        "content-type": "application/json",
      },
...
export async function getArtworksMe(value, listed = false) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork/artworks/me?listed=${listed}`,
    {
      headers: {
        "content-type": "application/json",
        authorization: `Bearer ${value}`,
...
export async function getArtworkById(id) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork/${id}?collection=true&editions=true&owner=true`,
    {
      headers: {
        "content-type": "application/json",
      },
...
export async function getCollectionById(id) {
  const res = await fetch(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork/${id}?artworks=true&owner=true`,
    {
      headers: {
        "content-type": "application/json",
      },
...
export async function putArtwork(value, values, artwork) {
  ...
  const res = await axios.put(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork/${artwork.id}`,
    {
      id: artwork.id,
      name: values.name,
      year: values.year,
...
export async function postArtwork(value, values, main_image) {
  ...
  const detailShotImageURL1 = await uploadImage(
    value,
    values.detailShotImage1[0]
  );

  const detailShotImageURL2 = await uploadImage(
    value,
...
export async function deleteArtwork(value, id) {
  const res = await axios.delete(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork/edition/${id}`,
    {
      headers: {
        "content-type": "multipart/form-data; charset=UTF-8",
        authorization: `Bearer ${value}`,
...
export async function uploadJSON(value, json) {
  ...
  const res = await axios.post(
    "https://marketplace-backend-dev.unveil.art/api/v1/upload/json",
    formdata,
    {
      headers: {
        "content-type": "multipart/form-data; charset=UTF-8",
...
export async function createNFT(value, _data, id) {
  const res = await axios.post(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork/create/${id}`,
    _data,
    {
      headers: {
        "content-type": "application/json; charset=UTF-8",
...
export async function listArtwork(value, id, list) {
  const res = await axios.put(
    `https://marketplace-backend-dev.unveil.art/api/v1/artwork/artwork-listing/${id}?list=${list}`,
    {},
    {
      headers: {
        "content-type": "application/json; charset=UTF-8",
...
export async function postTransaction(value, _data) {
  const res = await axios.post(
    `https://marketplace-backend-dev.unveil.art/api/v1/transaction`,
    _data,
    {
      headers: {
        "content-type": "application/json; charset=UTF-8",
