...
export async function postArtworks(value, values) {
  const detailsShots = [];
  ...
  if (values.detailShotImage1 && values.detailShotImage1.length > 0) {
    const detailShot1 = {
      ...
      image_url: URL.createObjectURL(values.detailShotImage1[0]),
    };
  ...
  if (values.detailShotImage2 && values.detailShotImage2.length > 0) {
    const detailShot2 = {
      ...
      image_url: URL.createObjectURL(values.detailShotImage2[0]),
    };
