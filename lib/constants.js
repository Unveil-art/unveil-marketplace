export const FACTORY_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FACTORY_ADDRESS;
...
export const MARKET_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MARKET_ADDRESS;
...
export const EARLY_ACCESS_CONTRACT_ADDRESS =
  process.env.NEXT_PUBLIC_EARLY_ACCESS_ADDRESS;
